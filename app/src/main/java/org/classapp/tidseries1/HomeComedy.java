...
public class HomeComedy extends AppCompatActivity {
    ...
    private void fetchMovies() {
        String url = "https://www.json-generator.com/api/json/get/cpYlfMnpqq?indent=2";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0 ; i < response.length() ; i ++){
                    ...
                    MovieAdapter adapter = new MovieAdapter(HomeComedy.this, movieList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(HomeComedy.this, "", Toast.LENGTH_SHORT).show();
